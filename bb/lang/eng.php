...
$l_search[10] = 'Search phrase length can`t be more than 100 symbols. Also minimum length of any word is 3 in "Any words" type of search and at least one word must be more than 2 symbols in any other type of search, except for the case, when you\'re searching within number of days and the "days" value doesn\'t exceed default "days" value for this community - the one, which you see here in the "days" input area right after clicking on the "Search" link.';
...
$l_enterIP = 'Enter correct IP or user ID';
$l_ban = 'Ban user IP/ID';
$l_unsetBan = 'Unset/unban selected IPs/IDs';
