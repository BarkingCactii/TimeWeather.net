...
<tr>'.$tabs.'</tr>
	...
	if (!$_GET['id'] || ($p_user = db_saq('SELECT id, alias FROM fud26_users WHERE id='.(int)$_GET['id']))) {
		ses_update_status($usr->sid, 'Browsing referrals');

		$c = uq('SELECT alias, id, join_date, posted_msg_count, home_page FROM fud26_users WHERE referer_id='.(int)$_GET['id']);
		if (($r = @db_rowarr($c))) {
			$refered_entry_data = '';
			do {
	...
	<td class="nw GenText"><a href="index.php?t=showposts&amp;id='.$r[1].'&amp;'._rsid.'"><img src="theme/default/images/show_posts.gif" alt="Show Posts" /></a>'.((_uid && $FUD_OPT_1 & 1024) ? '&nbsp;<a href="index.php?t=ppost&amp;'._rsid.'&amp;toi='.$r[1].'"><img src="theme/default/images/msg_pm.gif" /></a>' : '' ) .(!empty($r[4]) ? '&nbsp;<a href="'.$r[4].'" target="_blank"><img src="theme/default/images/homepage.gif" /></a>' : '' ) .($FUD_OPT_2 & 1073741824 ? '&nbsp;<a href="index.php?t=email&amp;toi='.$r[1].'&amp;'._rsid.'"><img src="theme/default/images/msg_email.gif" /></a>' : '' ) .'</td>
</tr>';
			} while (($r = db_rowarr($c)));
		} else {
			$refered_entry_data = '<tr><th colspan=4>No referrals yet.</th></tr>';
		}
	} else {
		invl_inp_err();
	}
...
<tr><th>Forum members referred by: <b><a href="index.php?t=usrinfo&amp;id=<?php echo $p_user[0]; ?>&amp;<?php echo _rsid; ?>" class="thLnk"><?php echo $p_user[1]; ?></a></b></th><th class="ac nw">Message Count</th><th class="ac nw">Registered On</th><th class="ac nw">Action</th></tr>
