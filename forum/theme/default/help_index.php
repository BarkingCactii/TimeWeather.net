...
* $Id: help_index.php.t,v 1.14 2004/11/24 19:53:35 hackie Exp $
*
...
if (_uid === '_uid') {
	...
	switch ($section) {
		...
		case 'boardusage':
		case 'readingposting':
			$file = 'c:/Inetpub/wwwroot/forum/theme/default/help/' . $section . '.hlp';
			$return_top = '<div align="center" class="GenText">[ <a href="index.php?t=help_index&amp;'._rsid.'">Return to Help Index</a> ]</div>';
			break;
		default:
			$file = 'c:/Inetpub/wwwroot/forum/theme/default/help/faq_index.hlp';
			$return_top = '';
	}

	ses_update_status($usr->sid, 'Reading the <a href="index.php?t=help_index">FAQ</a>');
	$TITLE_EXTRA = ': FAQ';
...
<tr><th>'.$topic_title.' <a href="javascript://" onClick="chng_focus(\'top\');" class="thLnk">back to top</a></th></tr>
